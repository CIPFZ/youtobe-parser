...
async def call_llm_translation(texts: List[str]) -> List[str]:
    ...
    payload = {
        ...
        "messages": [
            {"role": "system",
             "content": "You are a professional subtitle translator. You always return exactly the same number of lines as provided, maintaining the exact 'LineNumber|TranslatedText' format."},
